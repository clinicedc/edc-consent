    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_code', models.CharField(help_text="This refers to the site or 'clinic area' where the subject is being consented.", max_length=25, verbose_name='Site')),
        ...
        migrations.AddField(
            ...
            name='visit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='example.Visit'),
        ),
        migrations.AlterUniqueTogether(
            name='testconsentmodel',
            unique_together=set([('first_name', 'dob', 'initials', 'version'), ('identity', 'version'), ('subject_identifier', 'version')]),
        ),
        migrations.CreateModel(
