# -*- coding: utf-8 -*-
#
# bhp_consent documentation build configuration file, created by
...
htmlhelp_basename = 'bhp_consentdoc'
...
latex_documents = [
  ('index', 'bhp_consent.tex', u'bhp\\_consent Documentation',
...
man_pages = [
    ('index', 'bhp_consent', u'bhp_consent Documentation',
...
texinfo_documents = [
  ('index', 'bhp_consent', u'bhp_consent Documentation',
   u'erik van widenfelt', 'bhp_consent', 'One line description of project.',
   'Miscellaneous'),
]
