from edc_identifier.classes import SubjectIdentifier
...
class ConsentedSubjectIdentifier(SubjectIdentifier):
    ...
    Note: registered subject is created on a signal in bhp_subject
    by the edc_consent model (which is a subclass of BaseSubject).
    """
